...
import logofoot from './images/logo_foot1.png';
...
export default function App() {
    ...
    return(
      ...
      <div style={{ width:'100%', backgroundColor:'black',color:'white',paddingTop:30, paddingBottom:20,fontSize:15 }}>
        <Container>
          <Row>
            <Col md={5} sm={12}>
              <p style={{ fontSize:18 }}><b> Về HIGHLANDS COFFEE </b></p><br/>
              <p>Chúng tôi mong muốn mang đến cho bạn những trải nghiệm đáng nhớ mỗi lần đến Highlands Coffee®.
                Hãy chia sẻ với chúng tôi để chúng tôi có thể mang đến cho bạn những trải nghiệm tuyệt vời hơn thế.</p><br/>
              <span>Quý khách chắc chắn sẽ hài lòng về chất lượng sản phẩm và dịch vụ của chúng tôi.</span>   
            </Col>
            <Col md={3} sm={12}>
              <div  style={{ width:'100%', textAlign:'center'}}>
              <Image className="logofoot"  width="100%" height={200} src={logofoot} ></Image>
              </div>
              <div  style={{ display:'flex', justifyContent:'space-evenly',paddingBottom:20 }}>

              <a href="https://www.highlandscoffee.com.vn/"><IoLogoFacebook className="iconcontact" size={28} color="white" /></a>
              <a onClick={()=>{window.open('mailto:customerservice@highlandscoffee.com.vn?subject=Chủ%20đề%20cần%20phản%20hồi&body=Phản%20hồi%20của%20bạn')}} href="#"><SiGmail className="iconcontact" size={28} color="white"/></a>
            ...
            <Col md={4} sm={12}>
              ...
              <ul>
                <li>
                  <p>Địa chỉ : 258 Bạch Đăng,P. Phước Ninh, Q.Hải Châu, Tp. Đà Nẵng</p>
                </li>
                <li>
                  <p>Điện thoại : (0236) 710 9778</p>
                </li>
                <li>
                  <p>Email : highlands@gmail.com</p>
                </li>
      ...
      <p> contact for website: txphuong.19it4@vku.udn.vn or nxlinh.19it4@vku.udn.vn </p>
      </div>
      </div>
    )
  }
  return (
    ...
    <Navbar className="header-nav" style={top ? {width:'100%'}:{position:'fixed',width:'100%',top:0,elevation:10,zIndex:100}} collapseOnSelect expand="lg" bg="danger" variant="dark" >
      <Navbar.Brand as={Link} to={"/"} ><b> HIGHLANDS COFFEE </b></Navbar.Brand>
      ...
      <Navbar.Collapse id="navbarScroll" >
        <Nav
          ...
          navbarScroll>
           ...
           <Nav.Link onClick={()=>window.scroll(0,0)} href="#banan"></Nav.Link>
            <NavDropdown href="#foodmenu" title="Thực đơn" id="navbarScrollingDropdown">
