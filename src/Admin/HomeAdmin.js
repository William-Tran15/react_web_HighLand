        ...
        (<div>
            {permission &&
                ...
                {/* <Navbar.Collapse style={{ width:'100%' }}  className="flex-column"  > */}
                    <Navbar.Brand style={{textAlign:'center' }} href="#home"><h4>HIGHLANDS <hr/> COFFEE </h4></Navbar.Brand><br/>
                    <span style={{textAlign:'center',color:'white' }}><BiDish size={20}/> Chúc bạn một ngày vui vẻ !!!</span>
                    ...
                    <IoFastFoodOutline/>   Thực Đơn </Nav.Link>
